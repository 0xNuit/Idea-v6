...
if (process.env.NODE_ENV === 'production') {
  ...
  app.use('/Construction/', express.static(__dirname + '/public/a/'));
  app.get('/Construction/*', (req, res) => res.sendFile(__dirname + '/public/a/index-ar.html'));
  app.use('/Advertising/', express.static(__dirname + '/public/c/'));
  app.get('/Advertising/*', (req, res) => res.sendFile(__dirname + '/public/c/index-ar.html'));
